#makes final template images including mask, brain extracted template, and priors
#smooths JLF segmentation of template to make all tissue priors except CSF
jifTemplate=/data/jag/BBL/projects/rewardAnalysis/template/5_JIF/jifTemplate.nii.gz
jlfDir=/data/jag/BBL/projects/rewardAnalysis/template/7_jif_oasis/
outDir=/data/jag/BBL/projects/rewardAnalysis/template/8_priors/
